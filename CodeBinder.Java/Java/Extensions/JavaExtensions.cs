        ...
        static JavaExtensions()
        {
            _replacements = new Dictionary<string, Dictionary<string, SymbolReplacement>>()
            {
                ...
                { "System.String", new Dictionary<string, SymbolReplacement>() {
                    { "op_Equality", new SymbolReplacement() { Name = "Java.BinderUtils.equals", Kind = SymbolReplacementKind.StaticMethod } },
                    { "op_Inequality", new SymbolReplacement() { Name = "Java.BinderUtils.equals", Kind = SymbolReplacementKind.StaticMethod, Negate = true } },
                } },

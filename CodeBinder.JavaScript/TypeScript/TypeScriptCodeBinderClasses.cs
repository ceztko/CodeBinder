...
export class BinderUtils
{
    ...
    static addMemoryPressure(bytesAllocated: number | bigint): void
    {
        napi.AdjustEternalMemory(BigInt(bytesAllocated));
    }

    static removeMemoryPressure(bytesAllocated: number | bigint): void
    {
        napi.AdjustEternalMemory(-BigInt(bytesAllocated));
    }
